# -*- coding: utf-8 -*-, taken from https://github.com/mattbierbaum/arxiv-public-datasets/blob/8b2e49fde5a1be13c777638d5f60cf0f5e0ae759/arxiv_public_data/fixunicode.py
import re
import unicodedata
